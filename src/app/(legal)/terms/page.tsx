...
export default function TermsPage() {
  return (
    <Prose>
      ...
      <p>
        These Terms of Service (&ldquo;Terms&rdquo;) govern your use of meetthefam (&ldquo;the
        Service&rdquo;), operated by Sanchit Bhatnagar (an individual). By using the
      ...
      <p>
        ...
        share read-only views with relatives. The Service is provided on an &ldquo;as
        is&rdquo; and &ldquo;as available&rdquo; basis. We do not guarantee that it will always be
      ...
      <p>
        ...
        photos, biographies, and relationships (&ldquo;Your Content&rdquo;). You grant us a
      ...
      <p>
        ...
        the &ldquo;Last updated&rdquo; date above. Continued use of the Service after
