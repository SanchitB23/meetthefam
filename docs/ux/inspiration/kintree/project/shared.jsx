...
const PersonNode = ({ person, current, onClick, onAdd, compact, size = 'm' }) => {
  ...
  return (
    <div onClick={onClick} style={{
      ...
      borderRadius: 16,
      border: `1px solid ${current ? 'var(--ink)' : 'rgba(60,40,20,.08)'}`,
      boxShadow: current
    ...
    >
      ...
      <div style={{
        ...
        lineHeight: 1.1,
      }}>{person.short || person.name.split(' ')[0]}</div>
      <div style={{
...
Object.assign(window, {
  Icon, Avatar, PersonNode, Pill, Button, Card, Branch, ScreenChrome, shade,
});
